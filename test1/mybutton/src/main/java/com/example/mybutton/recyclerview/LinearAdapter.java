...
public  class LinearAdapter extends RecyclerView.Adapter<LinearAdapter.LinearViewHodler> {
    ...
    //传入文字的
    @Override
    public LinearAdapter.LinearViewHodler onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder (LinearAdapter.LinearViewHodler holder, @SuppressLint("RecyclerView") int position) {
        holder.textView.setText("hello word");
